...
public interface ProductRepository extends JpaRepository<Product, Long>{
	...
	@Query("SELECT p FROM Product p WHERE p.category LIKE 'Northindian' AND p.avail LIKE 'yes'")
	public List<Product> getNorthindian();
	
	@Query("SELECT p FROM Product p WHERE p.category LIKE 'Southindian' AND p.avail LIKE 'yes'")
	public List<Product> getSouthindian();
	
	@Query("SELECT p FROM Product p WHERE p.category LIKE 'Punjabi' AND p.avail LIKE 'yes'")
