...
export class ProductService {
  ...
  getSouthindian():Observable<Product[]>{
    return this.httpClient.get<Product[]>(`${this.baseURL}/southindian`);
  }

  getNorthindian():Observable<Product[]>{
    return this.httpClient.get<Product[]>(`${this.baseURL}/northindian`);
  }

  getPunjabi():Observable<Product[]>{
    return this.httpClient.get<Product[]>(`${this.baseURL}/punjabi`);
  }
